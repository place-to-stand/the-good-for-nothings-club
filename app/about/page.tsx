...
export default async function About() {
  ...
  return (
    <PageShell title='About'>
      <div className='flex flex-col gap-24 pt-10 lg:flex-row lg:gap-12'>
        <div className='prose prose-lg not-first-of-type:md:prose-xl prose-li:my-1 prose-ol:my-1 mx-auto font-sans leading-snug'>
          <h2>Overview</h2>
          <p>
            The Good for Nothings Club is a creators club based in Austin, TX
            made up of musicians, photographers, writers, filmmakers, and
            engineers. It started as a weekly accountability meeting between
            friends and grew into a clubhouse: studios, rehearsal rooms, and
            workspace under one roof.
          </p>
          <p>
            As members, we have always tried to strike a balance between work
            and pursuing our passions such as film, music, app development, and
            more. Our growth is deliberate and gradual, focused on keeping the
            work within our team and close friends. We are not building a
            business of infinite revenue and scale — that tends to consume all
            of your time and prevent you from pursuing your creative endeavors.
            The club exists to keep the space sustainable and the work flowing.
          </p>

          <h3>What happens here</h3>
          <ul>
            <li>
              <Link href='/facilities'>The clubhouse</Link> rents desks, band
              practice slots, a photo studio, and a recording control room.
            </li>
            <li>
